...
* **Vấn đề:** Khi chạy dưới dạng Web/PWA, dung lượng lưu trữ ảnh Base64 trong IndexedDB dễ bị trình duyệt dọn dẹp (eviction) nếu dung lượng lớn, đồng thời người dùng không nhận được phản hồi trực quan khi ứng dụng hoàn thành đồng bộ trong nền.
* **Giải pháp khắc phục:**
